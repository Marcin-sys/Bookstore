...
public class OrderDAO implements IOrderDAO {
    ...
    private final String GET_BY_ID_HQL = "FROM pl.mirocha.marcin.it.book.store.model.Order WHERE id = :zmienna";
    private final String GET_ALL_HQL = "FROM pl.mirocha.marcin.it.book.store.model.Order";
    private final String GET_ORDERS_BY_USER_ID_HQL = "FROM pl.mirocha.marcin.it.book.store.model.User " +
            "WHERE id = :id";
    ...
    public List<Order> getByUserId(int userId) {
        Session session = this.sessionFactory.openSession();
        Query<User> query = session.createQuery(GET_ORDERS_BY_USER_ID_HQL, User.class);
