...
public class UserDAO implements IUserDAO {
    ...
    private final String GET_BY_ID_HQL = "FROM pl.mirocha.marcin.it.book.store.model.User WHERE id = :id";
    private final String GET_BY_LOGIN_HQL = "FROM pl.mirocha.marcin.it.book.store.model.User WHERE login = :login";
    private final String GET_ALL_HQL = "FROM pl.mirocha.marcin.it.book.store.model.User";
