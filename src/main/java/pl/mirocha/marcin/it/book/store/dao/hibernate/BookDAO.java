...
public class BookDAO implements IBookDAO {
    ...
    private final String GET_BY_ID_HQL = "FROM pl.mirocha.marcin.it.book.store.model.Book WHERE id = :zmienna";
    private final String GET_ALL_HQL = "FROM pl.mirocha.marcin.it.book.store.model.Book";
    private final String GET_BY_PATTERN_HQL = "FROM pl.mirocha.marcin.it.book.store.model.Book " +
